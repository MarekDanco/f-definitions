...
\]
We can then merge the two universal quantifiers into one and continue out algorithm normally.
This normalization may potentially significantly reduce the amount of iterations in the while
cycle of Algorithm~\ref{alg:sr}\mj{This is also true but in this example we
cannot apply the algorithm at all. Maybe you want to have a different example
for that.} \marek{I think you can. Can we discuss this?}.
