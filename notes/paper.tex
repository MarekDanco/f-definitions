...
\begin{definition}\todoSR{Sorry, I changed this once more. The intuition stays the same.}
    ...
    \begin{itemize}
        ...
        \item for every instantiation $\psi$ of a quantified sub-formula of $\phi$, a set of entities (the \emph{existential entities}) that are neither assigned a values by $I$, nor occur in any $\Gamma_I(\psi')$ for an instantiation $\psi'\prec\psi$
