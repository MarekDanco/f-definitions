...
(possibly in \cite{kuncak-pldi10} or \cite{kuncak-sttt13}).
...
Here, both of the dijuncts satisfy \emph{ReqPivot}. That means we can form complementary preconditions
