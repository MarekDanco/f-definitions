...
\begin{itemize}
    ...
    \item program analysis
      ...
      \item non-termination: most techniques seem to look for loops, but programs over integers (as opposed machine integers) may also diverge without a loop: For example, for the program
