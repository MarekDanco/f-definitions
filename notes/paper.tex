...
\todoSN{Then I think below is the new ReqPivot definition for now?}
\marek{Almost, see this problem with only nonstandard models. $\forall x. f(x)<f(x+1) \land f(x)<0$}
...
\marek{This is wrong I don't know how I came up with it. At least we now have the nice induction
	example because of it. The rest of the ``proof'' is wrong too.}
