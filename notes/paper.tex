...
an entity interpretation $I'$ with $\mathit{def}(I')=\Gamma_{I,z}(\phi)\setminus \mathit{def}(I)\setminus X_z$, $I\cup I'\cup \{ u \mapsto prop_{u}(I\cup \{ x\mapsto z\}) \mid u\in{X_z}\}\models\subst{Q}{x}{\repr{z}}$.\todoSR{I am currently working on this. In the meanwhile, do not expect it to make sense.}
