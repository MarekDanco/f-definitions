...
cycle of Algorithm \ref{alg:sr}. Note that this doesn't work for conjunction.

\subsection*{Conjunction}

TODO include notes from meeting
...
In the following problem we need induction to prove $\textsc{unsat}$
\footnote{In general, we could look for bounds of the form $\forall x. \,f(x) < G$ for $G$ ground.
