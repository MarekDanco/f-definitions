...
\[x < \min I \leq \max I < x',\]
\todoSR{Stefan, should this not be enough? This just uses non-emptiness of $I$, but no minimal size.}
and hence $x+c^{f_{i^*}}_1<x'+c^{f_{i^*}}_1$. 

The third condition follows from the fact that $x+c^{f_{i^{*}}}_1$ is the lowest argument of $f_{i^*}$.
    \end{description}
