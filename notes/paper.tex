...
\begin{property}
	...
	\end{itemize}
	Then the order $\max I+1, \max I+2, \dots, \min I-1, \min I-2,\dots$, together with the entity interpretation $\alpha$, and propagators for ReqPivot form a satisfiability certificate for $F\wedge \forall x \:.\: Q$.
\end{property}
