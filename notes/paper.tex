...
\end{itemize}
In the following, we will call this condition ReqPivot. We will assume that we have corresponding satisfiability propagators (see Definition~\ref{def:certificate})
available.
...
\begin{property}
    \label{prop:cert}
    Moreover, assume an integer interval $I$ and an entity interpretation $\alpha$ s.t.
    \begin{itemize}
