...
\end{equation}
The formula is unsatisfiable\todoSR{It looks satisfiable to me (e.g., $\{ f\mapsto\lambda x\,.\,1, c\mapsto 0 \}$), maybe you forgot $f(0)=0$?} as long as we have access to induction.%
