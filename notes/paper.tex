...
Consider the choice $S_f = \{4\}, \quad S_g = \{2\}, \quad S_h = \emptyset$.
    \begin{enumerate}
        ...
        \item For $f$: $S_f = \{4\}$, $T_f \setminus S_f = \{c+3, 1\}$
          % $4 > 1$ is true. $4 > c+3$ becomes a constraint: $c < 1$.
            ...
            \end{itemize}
This results in $\Phi_{\text{max}}\equiv 4 = 4 \land 4 > c+3 \land 4 > 1 \land\ 2=2$, which is true 
provided $c < 1$.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \end{itemize}
This results in $\Phi_{\text{min}}\equiv 1 = 1\land 1 < c+3 \land 1 < 4 \ \land\  0=0$, which is true provided
 $c > -2$.
