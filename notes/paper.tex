...
where $F$ is quantifier free, for every $i\in \{1,\dots,r\}$, and the  $t^{f_i}_{1},\dots,t^{f_i}_{l_i}$ are LIA ground terms~\todoSR{We are about to extend the algorithm to this case. Is ``LIA ground term'' correct terminology?}
