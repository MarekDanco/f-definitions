...
interpretation of $g$.
Now, for any pair $(i, j) \not= (3, 0)$ of integers, we can define $f^{\gmodel}(i, j)$ to be
$i + 1$ or $i - 1$ for even or odd $j$ respectively. In the end, we can expand $\gmodel$
...
\begin{definition}[Satisfiability Certificate, Propagator]
