...
We introduce a method for certifying satisfiability of SMT formulas with uninterpreted function symbols ranging over a countable canonical domain, typically coming from the 
SMTLIB theory UFLIA that combines uninterpreted function symbols with linear integer arithmetic. The formulas we consider are
of the form
...
\mj{$a-a$ is 0 under a theory, but somehow theories are not mentioned here}
