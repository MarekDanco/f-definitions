...
\begin{example}
    ...
    The set $\{ f(2x+c), f(2x+c-1)\}$ can be our $\mathcal{T}_p$ with $x_p=x$. The term $g(x+y)$ cannot be in $\mathcal{T}_p$ since both quantified variables have non-zero coefficient.
\end{example}
