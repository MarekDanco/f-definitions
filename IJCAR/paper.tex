...
\begin{enumerate}
    ...
    \item \textbf{Propagated cells $X_z$ for $z \in \mathbb{Z}$:}\todoSR{I had to change $t$ to $I(t)$ to take into account the case where $t$ contains uninterpreted constants}
    \[
    X_z = 
    \begin{cases}
