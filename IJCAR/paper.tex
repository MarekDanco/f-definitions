...
\begin{enumerate}
    ...
    \bigl\{ f_i(z+I(t)) \mid i=1,\dots,r,\; t \in S_i \bigr\} & \text{if } z > b_{\max}, \\[4pt]
    \bigl\{ f_i(z+I(t)) \mid i=1,\dots,r,\; t \in S_i' \bigr\} & \text{if } z < b_{\min}.
    \end{cases}
    \]
...
\begin{itemize}
    ...
    \item For $z > b_{\max}$, consider any $f_i(z+I(t))$ with $t \in S_i$.
    \begin{itemize}
        ...
        \begin{enumerate}
            \item $z' \leq b_{\max}$: then $z'+I(t') \leq b_{\max} + I(t') < z + I(t)$ for all $t' \in T_i$, since $z > b_{\max}$ and $I(t)$ is maximal among offsets of $f_i$.
