...
\end{definition}
We denote the set of cells by $C(\domain)$.\marek{this means all cells that exist in the signature and also by plugging in all possible $n$-tuples from $\domain^n$?}
