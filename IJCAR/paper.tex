...
\begin{itemize}
    ...
    \begin{itemize}
        \item It cannot belong to $\mathit{def}(I)$ because the clash condition $a \leq \subst{t}{x}{\repr{b}_{\max}}$ in $\Psi_{\text{up}}(B,\mathcal{S})$ guarantees that for every ground argument $a \in \args(F,f)$:
        \[
