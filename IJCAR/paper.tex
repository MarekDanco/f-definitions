...
We will use the classical mathematical notion of a well-order. A well-order on a set $S$ is a total ordering on $S$
such that every non-empty subset of $S$ has a least element. Any well-order allows well-founded induction; to prove
