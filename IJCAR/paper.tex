...
\begin{itemize}
    \item We formalize the notion of \emph{cell propagation certificates} (\cref{def:certificate}) that witness satisfiability through inductive extension of finite base assignments.
...
\section{Related Work}\todoSN{Stefan R, could you please check this? I am afraid that I use wrong words or wrong summaries of the papers cited.}
