...
Our approach does not assign values to the entire infinite domain of uninterpreted function symbols in one step; instead, it assigns values to each individual element of this domain:
