...
\begin{enumerate}
    \item \textbf{Pre‑satisfiability assignment:} Define the cell interpretation~$I$ as follows:
      \begin{itemize}
        ...
        \item For each cell $f(I^*(\subst{t}{x}{\repr{z}}))$ with $z\in B$ and $f(t)$ occurs in $Q$, set its value to $I^*(f(\subst{t}{x}{\repr{z}}))$.
    \end{itemize}
    ...
    \begin{itemize}
        \item For $z \in B$: since $X_z$ is empty, $I\models\subst{Q}{x}{\repr{z}}$ suffices.
