...
Syntax-Guided Synthesis (SyGuS) \cite{cvc5} enumerates candidate functions from a grammar. Hence its performance depends crucially on the chosen grammar. Moreover, it synthesizes function in an explicit representation, disallowing recursion\todoSR{right?}. Our method does beyond that, using inductive reasoning.
