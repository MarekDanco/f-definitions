...
\title{%
    Inductive Function Definitions\todoSN{We will change this title. For the affiliation, I'm not sure what to put for Mikoláš and Marek.} \todoSN{Title options: ``Inductive Cell Propagation for Quantified UFLIA" or ``Deciding UFLIA with Offset Constraints through Inductive Propagation" or ``Cell Propagation Certificates: A Decision Procedure for Offset-Restricted UFLIA"}
    }

% \author{Stefan Ratschan \and Anggha Nugraha \and Mikoláš Janota \and Marek Dančo}
\author{Stefan Ratschan\inst{1,2}\orcidlink{0000-0003-1710-1513} \and
