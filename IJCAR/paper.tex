...
We implemented our algorithm in the language Python, using the SMT solver \textsc{z3} for all satisfiability checks. We also applied the \textsc{smt} solvers \textsc{z3} and
