...
\begin{itemize}
\item introduce a notion of satisfiability certificate the represents  inductive arguments for satisfiability of such formulas, we
...
\item proof soundness and relative\todoSR{I will mke this more precise} completeness, and we
