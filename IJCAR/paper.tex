...
There has been recent efforts in TPTP~\cite{SteenSFM23} and SMT~\cite{Barbosa:23,BarbosaROTB19,lachnitt_et_al:LIPIcs.ITP.2025.26,leansmt}
...
Given a pre-satisfiability certificate, we can now certify the satisfiability of formulas by propagating the values given by a pre-satisfiablity certificate in such a way that for each value of the universally quantified variables, the corresponding quantified sub-formula holds.
