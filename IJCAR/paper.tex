...
We have prepared a short test suite consisting of 16 small problems such as
\begin{align}\label{eq:exp1}
	f(4)=7 \;\land\; \forall x.\; (0 \le x \le 10^c \;\Rightarrow\; f(x+1)=f(x)+1),
\end{align}
where we tested how well do the state of the art \textsc{smt} solvers \textsc{z3} and 
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{experiments/data/scaling_plot.png}
        \caption{Benchmarks solved}
        \label{fig:scaling}
    \end{subfigure}
    \hfill
    % Second subfigure
    \begin{subfigure}{0.5\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{experiments/data/scatter_runtime.png}
        \caption{Solver runtime}
        \label{fig:scatter}
    \end{subfigure}
    \caption{Summary of solver performance as a function of parameter $c$.}
\end{figure}
