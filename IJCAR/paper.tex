...
\item The set of coefficient vectors of all argument terms of uninterpreted function symbols in $Q$ is collinear, and the non-zero coefficient vectors of the arguments of each individual uninterpreted function symbol are identical.
    \item All uninterpreted function symbols have maximal arity $1$.
    \item An additional semantic condition enabling induction (\cref{def:reqpivot-param})
\end{itemize}
