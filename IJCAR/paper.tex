...
Apart from the upper bound $10^c$, our problems do not contain big integers in function arguments, which would necessitate smarter initialization of the interval~$[b_{\min},b_{\max}]$ in order to avoid numerous loop iterations of the while loop in \cref{alg:interval-check-param-withBigvee}.
...
Moreover, the value of the parameter~$c$ does not noticeably influence on runtime
