...
<<<<<<< HEAD
  This contradicts the requirement that $X_{\mathit{inst}(v)}\cap \mathit{def}(I)=\emptyset$ and $X_{\mathit{inst}(v)}\cap\bigcup_{z'\prec inst(v)} \Gamma_{I,z'}(\phi)=\emptyset$.
=======
...
>>>>>>> a9e4edc (implemented  claude suggestions)
  \qedhere
