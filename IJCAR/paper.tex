...
Our approach will not assign values to all elements of the infinite domain of uninterpreted function symbols in one step, but to each individual element of this domain separately:
