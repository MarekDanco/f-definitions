...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        For type~(2), since $z_0 \le b_{\max} < z$ and $t$ is extremal for $s=+$, we obtain
        \[
        \begin{aligned}
            I \models\;&\subst{t_0}{x}{\repr{z_0}}\cmpsign{\coeffsign{f}+}\subst{t_0}{x}{\repr{b}_{\max}} \\
            \models\;&\subst{t_0}{x}{\repr{b}_{\max}}\cmpsignstrict{\coeffsign{f}+}\subst{t}{x}{\repr{b}_{\max}+1} \\
            \models\;&\subst{t}{x}{\repr{b}_{\max}+1}\cmpsign{\coeffsign{f}+}\subst{t}{x}{\repr{z}},
        \end{aligned}
        \]
        and therefore $I\!\left(\subst{t_0}{x}{z_0}\right)\neq I\!\left(\subst{t}{x}{z}\right)$.
