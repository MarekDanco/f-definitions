...
However, we require that enough cells are defined to (i)~check satisfaction of quantifier-free parts of formulas, and (ii)~determine the value of all arguments of uninterpreted function symbols for every universally quantified subformula and every instantiation of the universal quantifier.
